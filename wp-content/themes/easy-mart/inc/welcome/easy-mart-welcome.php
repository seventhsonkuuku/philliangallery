			...
			<div class="changelog point-releases">
				<div class="under-the-hood two-col">
					...
					<div class="col">
						...
						<p><a href="<?php echo esc_url( 'https://codevibrant.com/support/' ); ?>" class="button button-secondary" target="_blank"><?php esc_html_e( 'Support', 'easy-mart' ); ?></a></p>
					</div>
					...
					<div class="col">
						<h3> <?php echo esc_html( 'Translate', 'easy-mart' ).' '.esc_html( $theme_name ); ?> </h3>
						<p><?php esc_html_e( 'Click below to translate this theme into your own language.', 'easy-mart' ) ?></p>
						<p>
							<a href="<?php echo esc_url( 'https://translate.wordpress.org/projects/wp-themes/easy-mart' ); ?>" class="button button-secondary" target="_blank"><?php echo esc_html( 'Translate', 'easy-mart' ).' '.esc_html( $theme_name ); ?></a>
						</p>
					</div>
				</div>
			</div><!-- .point-releases -->
