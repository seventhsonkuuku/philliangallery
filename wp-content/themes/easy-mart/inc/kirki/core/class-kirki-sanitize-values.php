...
class Kirki_Sanitize_Values {
	...
	/**
	 * Social Icons sanitization callback.
	 *
	 * - Sanitization: social-icons
	 * - Control: social-icons
	 *
	 * Sanitization callback for 'social-icons' type controls. This callback sanitizes `icon class`
	 *
	 * @param string class.
	 * @param WP_Customize_Setting $setting Setting instance.
	 * @return string icon clas
	 */
	public static function social_icons( $value ) {
		// Ensure $input is an absolute integer.
